...
<Callout type="info">
  HTTP/3 is already supported by major platforms like Google, Facebook, and Cloudflare. It's
  becoming the new default for high-performance web communication.
</Callout>
