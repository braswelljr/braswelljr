      ...
      <div className="mx-auto max-w-xl px-4 text-gray-800 child:space-y-6 dark:text-neutral-100 sm:mt-14 sm:child:space-y-10">
        ...
        <div className="md:leading-relaxed">
          <p className="">
            ...
            . I started as a Software Engineer back in 2018 working on freelance projects and
          ...
          <p>
            ...
            . I have had multiple experiences with firms and individuals with which I would say
            benefited me and my experence. I completed{' '}
            <a
        ...
        <div className="mt-10">
          ...
          <div className="">
            <a
              className="inline-flex w-full items-center justify-center space-x-2 rounded-sm bg-neutral-900 px-2 py-1.5 uppercase text-neutral-100 backdrop:backdrop-blur hover:bg-neutral-800 focus:outline-none dark:bg-neutral-500/50 dark:text-white"
