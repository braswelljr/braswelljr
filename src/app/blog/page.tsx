    ...
    <>
      <div className="px-4 py-10 pt-[calc(var(--fd-nav-height)+10px)]">
        <div className="mx-auto max-w-4xl px-4 text-gray-800 *:space-y-6 sm:mt-14 sm:*:space-y-10 dark:text-neutral-100">
          <h2 className="text-primary! text-2xl leading-tight font-bold tracking-tight uppercase sm:text-3xl md:text-4xl">Blog</h2>

          <div className="relative ml-4 pt-5 sm:ml-[calc(2rem+1px)] md:ml-[calc(3.5rem+1px)] lg:ml-[max(calc(15.5rem+1px),calc(100%-48rem))]">
            <div className={cn('bg-primary! absolute top-3 right-full -bottom-10 w-px', 'mr-7 ml-5 md:mr-13')} />
                ...
                return (
                  ...
                  >
                    ...
                    <svg
                      viewBox="0 0 9 9"
                      className={cn(
                        'text-primary! absolute top-2 right-full size-[calc(0.5rem+1px)] overflow-visible',
                    ...
                    <div className="relative">
                      {(after || !published) && (
                        <div className="relative flex flex-wrap gap-2 pt-8 lg:pt-0 lg:pb-3">
                          {after && (
                            <div className="bg-primary-300 dark:bg-primary text-xsm inline-flex h-6 w-auto items-center gap-1 rounded-sm px-1.5 py-1 pr-2 font-bold text-neutral-950 uppercase">
                      ...
                      {Array.isArray(tags) && tags.length && (
                        <div className="my-2 mb-4 flex flex-wrap gap-2">
                          {tags.map((tag, i) => (
                            <span
                              key={i}
                              className="bg-primary-200 dark:bg-primary text-xsm inline-flex items-center rounded-sm px-2 py-1 font-medium text-neutral-950"
                            >
                              {tag}
                            </span>
                          ))}
                    ...
                    <Link
                      href={slug}
                      className="link-underline group/link text-primary! relative mt-5 inline-flex items-center justify-start gap-1 pb-1 pl-1.5 text-sm font-semibold uppercase hover:bg-size-[95%_3px]"
                    >
                      <span className="">
