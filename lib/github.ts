...
export const repo = 'braswelljr';
export const owner = 'braswelljr';
export const BlogCategory = 'Blog Feedback';
...
export async function getOctokit(): Promise<Octokit> {
  ...
  if (!appId || !privateKey) {
    throw new Error('No GitHub keys provided for Github app, blog feedback feature will not work.');
  }
...
//   if (!category) throw new Error(`Please create a "${BlogCategory}" category in GitHub Discussion`);
